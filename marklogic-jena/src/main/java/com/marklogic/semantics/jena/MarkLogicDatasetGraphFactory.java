...
/**
 * Contains static methods for creating a MarkLogicDatasetGraph, which is a
 * DatabsetGraph that is backed by a MarkLogic database and REST API.
 */
public class MarkLogicDatasetGraphFactory {

    /**
     * Creates a MarkLogicDatasetGraph from an existing
     * {@link com.marklogic.client.DatabaseClient}.
     * 
     * @param client
     *            An instance of DatabaseClient.
    ...
    /**
     * Creates MarkLogicDatasetGraph from access parameters to a REST MarkLogic
     * server.
     * 
     * @param host
